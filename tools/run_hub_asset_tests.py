"""Execute HubAssetContractTests hors Roblox.

Usage : python tools\\run_hub_asset_tests.py
"""
...
HARNESS = ROOT / "tools" / "test_hub_asset_contract.lua"
BUNDLE = ROOT / "tools" / "_hub_asset_contract_bundle.lua"
LUAU = ROOT / "tools" / "luau" / "luau.exe"
SHARED = ROOT / "src" / "Shared"

MODULES = [
    "HubAssetContract",
    "HubAssetContractTests",
]
...
def build_bundle() -> str:
    ...
    for name in MODULES:
        ...
        blocks.append(f"MODULE_LOADERS[{name!r}] = function()\n{source}\nend\n")
