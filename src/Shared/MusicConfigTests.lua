...
function MusicConfigTests.Run(): boolean
	...
	check(MusicConfig.TrackKeyForArea("AmusementPark") == "amusement", "AmusementPark key")
	...
	check(MusicConfig.TrackIdForArea("AmusementPark") == MusicConfig.AMUSEMENT_PARK_MUSIC_ID, "AmusementPark track")
	check(MusicConfig.SoundIdForTrackKey("challenge") == MusicConfig.MINI_EVENT_MUSIC_ID, "Mini-event challenge track")
